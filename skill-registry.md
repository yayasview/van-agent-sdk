...
| `linkedin-connection-checker` | `skills/linkedin-connection-checker/SKILL.md` | Check LinkedIn connection status for pending ABM contacts (two-step HubSpot query + browser check) | Active |
...
| `/check-connect` | `linkedin-connection-checker` | `/check-connect` |
